...
//
// Экспортируется ради объёмного режима: он кладёт появления в свой наземный
// слой и рисует их ЭТОЙ функцией, а не своей копией. Десять эффектов в двух
// экземплярах разошлись бы на первой же правке.

export function drawEntrance(ctx, e) {
