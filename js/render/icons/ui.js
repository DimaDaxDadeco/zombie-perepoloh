...
export const UI_ICONS = {
  ...
  // Плоский круг — пара к кубику. Он и означает «обычная картинка»: ребёнок
  // не читает, и различить два режима он может только по силуэту. Круг против
  // гранёного кубика читается сразу, а квадрат рядом с кубом выглядел просто
  // пустой кнопкой.
  'ui-flat': [
    { d: disc(16, 16, 11), fill: 'sky' },
    { d: ring(16, 16, 11, 2), fill: 'waterDark' },
  ],

  // Кубик в изометрии: переключатель объёмного режима. Три грани
  // разного тона — на шестнадцати пикселях именно разница тонов и читается
  // как «объём», сам контур там уже неразличим.
  'ui-cube': [
    { d: poly([[16, 3], [29, 10.5], [16, 18], [3, 10.5]]), fill: 'ice' },
    { d: poly([[3, 10.5], [16, 18], [16, 29], [3, 21.5]]), fill: 'waterDark' },
    { d: poly([[29, 10.5], [16, 18], [16, 29], [29, 21.5]]), fill: 'water' },
  ],
