...
export const CONFIG = {
  ...
  render3d: {
    ...
    light: {
      sunColor: '#fff6e0',
      sunIntensity: 2.1,
      // Направление на солнце, в долях от размера арены. Слева-сверху-сзади:
      // так тень падает вперёд-вправо и не прячется под самой фигуркой.
      sunAt: { x: -0.6, y: 1.4, z: -0.5 },
      skyColor: '#dff0ff',
      groundColor: '#6b6250',
    ...
    // Заготовки фигурок первого этапа: пока все персонажи капсулы, высота
    // считается от игрового радиуса. Ниже 3 капсула перестаёт читаться как
    // стоящая фигурка и превращается в яйцо — проверено глазами в стенде.
    figureHeightFactor: 3.6,
