...
export const CONFIG = {
  ...
  weapons: {
    ...
    tornado: {
      ...
      cooldown: [6, 5.4, 4.8, 4.2, 3.6],
      radius:   [110, 125, 140, 155, 175],
      damage:   [1, 1, 2, 2, 3],
      pull: 260,
      life: 5,
      speed: 90,
      tickTime: 0.4,   // как часто вихрь бьёт тех, кто внутри
    },
    ...
    hurricane: {
      ...
      cooldown: [3], radius: [230], damage: [4],
      pull: 380, life: 7, speed: 110, tickTime: 0.3,
    },
    watercannon: {
      evolved: true,
