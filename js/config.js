...
export const CONFIG = {
  ...
  characters: [
    ...
    },
    {
      id: 'hankey',
      name: 'Мистер Хэнки',
      about: 'С зомби падает больше медалек',
      perk: { dropBonus: 0.15 },
      ability: 'gifts',
      look: {
  ...
  abilities: {
    ...
    gifts: {
      name: 'Подарки', emoji: '🎁', about: 'Рассыпает вокруг медальки',
      color: '#e8434f',
      // Единственная способность, которая вообще не бьёт: она ДАЁТ. Медальки
      // идут в опыт, то есть в карточки прокачки — помощь непрямая, но
      // настоящая, а для пятилетнего дождь подарков сам по себе праздник.
      //
      // Сердечко за применение пробовали и убрали: оно стоило ОДИННАДЦАТИ
      // побед из девяноста (78 против 67) и в одиночку выносило Хэнки за
      // пределы коридора. Замеры — в balance.md.
      medals: 6, radius: 190,
    },
    zap: {
