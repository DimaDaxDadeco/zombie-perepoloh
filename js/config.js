...
export const CONFIG = {
  ...
  goals: {
    ...
    thief: {
      icon: 'ui-bag', count: 5,
      // Доля от скорости САМОГО МЕДЛЕННОГО героя — больше единицы намеренно.
      // Пока бежит, догнать его нельзя вовсе, и это не жестокость, а
      // единственный способ сделать задачу длиннее пяти секунд: погоня в
      // коробке при близких скоростях кончается мгновенно, куда бы прыть ни
      // девалась. Проверено тремя разными алгоритмами бегства.
      speedFactor: 1.06,
      ...
      intervalFactor: 1.05, batchBonus: 0,
    },
  },
