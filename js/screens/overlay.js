...
export class Overlay {
  ...
  // Произвольная картинка в кружке — тем же приёмом, что наклейки: с тем же
  // центрированием и тем же силуэтом для закрытой. Нужна карте, где в
  // медальоне рисуется не персонаж, а задача главы: клетка, костёр, подарок.
  static paintPicture(canvas, paint, options, scale = 0.3) {
